...
public class UpdateClinicGUI extends JFrame {
	...
	public UpdateClinicGUI(Clinic clinic) {
		...
		label.setBounds(20, 4, 171, 21);
		contentPane.add(label);
		
		fld_clinicName = new JTextField();
		fld_clinicName.setFont(new Font("Yu Gothic UI Light", Font.PLAIN, 16));
		fld_clinicName.setColumns(10);
		fld_clinicName.setBounds(20, 35, 179, 37);
		...
		btn_updateClinic.setBackground(Color.LIGHT_GRAY);
		btn_updateClinic.setBounds(20, 77, 179, 37);

...
public class HastaGUI extends JFrame {
	...
	public HastaGUI(Hasta hasta) throws SQLException {
		...
		w_scrollDoctor.setBounds(10, 30, 280, 330);
		...
		label_2.setBounds(301, 4, 94, 25);
		w_appointment.add(label_2);
		
		JComboBox select_clinic = new JComboBox();
		select_clinic.setBounds(300, 30, 139, 34);
		...
		lblDoktorSe.setBounds(301, 101, 94, 25);
		...
		btn_selDoctor.setBackground(Color.LIGHT_GRAY);
		btn_selDoctor.setBounds(300, 132, 139, 39);
		w_appointment.add(btn_selDoctor);
		
		JLabel lblUygunSaatler = new JLabel("Uygun Saatler");
		lblUygunSaatler.setFont(new Font("Yu Gothic UI Semibold", Font.PLAIN, 12));
		lblUygunSaatler.setBounds(449, 5, 83, 26);
		w_appointment.add(lblUygunSaatler);
		
		JScrollPane w_scrollWhour = new JScrollPane();
		w_scrollWhour.setBounds(449, 30, 252, 330);
		w_appointment.add(w_scrollWhour);
		
		table_whour = new JTable(whourModel);
		w_scrollWhour.setViewportView(table_whour);
		
		JLabel label_3 = new JLabel("Randevu:");
		label_3.setFont(new Font("Yu Gothic UI Semibold", Font.PLAIN, 15));
		label_3.setBounds(301, 197, 94, 25);
		...
		btn_addAppoint.setBackground(Color.LIGHT_GRAY);
		btn_addAppoint.setBounds(300, 228, 139, 39);
		...
		w_scrollAppoint.setBounds(10, 10, 691, 350);
